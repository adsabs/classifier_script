...
ASTRONOMY_THRESHOLD_DELTA = 0.0
HELIOPHYSICS_THRESHOLD_DELTA = 0.0
PLANETARY_SCIENCE_THRESHOLD_DELTA = 0.0
EARTH_SCIENCE_THRESHOLD_DELTA = 0.0
BIOPHYSICS_THRESHOLD_DELTA = 0.0
OTHER_PHYSICS_THRESHOLD_DELTA = 0.0
OTHER_THRESHOLD_DELTA = 0.0
